...
//•	Метод getObjectType() должен возвращать одно значение из: "Корова",
// "Кит", "Собака", "Неизвестное животное" в зависимости от переданного объекта.
// Например, "Корова" для объектов типа Solution.Cow.
public class L2_КакойОбъект {
