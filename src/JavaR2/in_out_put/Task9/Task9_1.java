...
//Используя шаблон проектирования Wrapper (Decorator) расширь функциональность Task10AmigoOutputStream/Task9.
...
//•	Класс QuestionFileOutputStream/Task9_1 должен реализовывать интерфейс Task10AmigoOutputStream/Task9.
