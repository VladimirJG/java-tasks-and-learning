 ...
 */
    ...
    public static List<String> correctedList(List<String> stringList) {
        ...
        for (int i = 0; i < stringList.size(); i++) {
            ...
            for (int i1 = 0; i1 < str.length(); i1++) {
                String symbol = String.valueOf(str.charAt(i1));
                if (symbol.toUpperCase().equals(symbol) && !symbol.equals(" ")) {
                    count++;
                }
            }
            if (count == 0) {
    ...
    public static HashMap<String, Integer> magSort(HashMap<String, Integer> shopCart) {
        ...
        for (HashMap.Entry<String, Integer> pair : shopCart.entrySet()) {
            if (pair.getValue() <= 300) {
